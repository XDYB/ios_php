...
//            ->update(['total_count' => $total, 'limit_count' => $limit]);
        ...
        $sup_id = Db::name("super_signature_ipa")->insertGetId($supData);
      	...
      	//$ml =  'isign -c '.$absolute_path.'public/spcer/liufuqiang/certificate.pem -k /www/wwwroot/cs.l0dt.cn/public/spcer/liufuqiang/key.pem -p "'.$files.'"  -o /www/wwwroot/cs.l0dt.cn/public/testIpa/'.$udid.'resigned.ipa "'.$ipa.'" 2>&1'.'<br/>';
      	//
