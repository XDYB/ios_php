...
class TestController extends HomeBaseController
{
    public function index(){
        ...
        //exec('export PATH=$PATH:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/root/bin;isign -c /www/wwwroot/cs.l0dt.cn/public/spcer/liufuqiang/certificate.pem -k /www/wwwroot/cs.l0dt.cn/public/spcer/liufuqiang/key.pem -p "/www/wwwroot/cs.l0dt.cn/public/ios_movileprovision/cd13d338e78ba64814771ad97b97be5ae837fedb.mobileprovision"  -o /www/wwwroot/cs.l0dt.cn/public/testIpa/cd13d338e78ba64814771ad97b97be5ae837fedbresigned.ipa "/www/wwwroot/cs.l0dt.cn/public/upload/super_signature/20190824/8fe04df45a22b63156ebabbb064fcd5e.ipa" 2>&1',$out,$status);
        //exec('ping cs.l0dt.cn 2>&1',$out);
        // exec('/www/wwwroot/cs.l0dt.cn/test.sh 2>&1',$out,$status);
            var_dump($out);
    }
