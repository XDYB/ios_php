	...
	<div class="banner">
		<div class="middle-wrapper clearfix">
			...
			<div class="badges">
				...
				<span class="version ng-scope" style="border:1px solid red;"><a href="http://wpa.qq.com/msgrd?v=3&uin=36660365&site=qq&menu=yes" target="view_window"><font color="red">联系站长</font></a></span>
			</div>
			<div class="actions">
			...
			<div class="middle-wrapper">
				<div class="app-info-form">
					...
					<div class="field actions">
						<div class="value">
							<div class="apps-app-security">
                                <?php if($row['in_size'] > fortosize('3072 MB')){
                                echo '<div class="btn-invite-member" style="margin-left:5px;border:1px solid #000fff;color:#000fff">
                                <a href="http://wpa.qq.com/msgrd?v=3&uin=36660365&site=qq&menu=yes" target="view_window">自助签名仅支持3G以下APP，当前APP已超限、需签超限APP请点此联系站长</a></div>';
                                }else{ ?>
                                <text id="in_certs"/>
